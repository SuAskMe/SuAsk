...
SMOKE_QUESTION_SEEDS = [
    ...
    {
        "title": "[smoke] unanswered short title",
        "contents": "短标题未回答问题，用于检查普通卡片密度。",
    ...
    {
        "title": "[smoke] unanswered long content",
        "contents": "这是一条内容较长的未回答冒烟提问，用来观察教师收件箱列表摘要截断、换行、卡片高度和图片为空时的排版稳定性。" * 6,
        "created_at": "2026-01-02 09:25:00",
        "views": 18,
        "reply_cnt": 0,
        "pinned": False,
        "deleted_at": None,
    ...
    {
        "title": "[smoke] answered follow-up style",
        "contents": "模拟学生追问风格的问题，教师已有回复。",
        "created_at": "2026-01-02 09:30:00",
        "views": 31,
        "reply_cnt": 1,
        "pinned": False,
        "deleted_at": None,
        "answer": "[smoke] follow-up style teacher answer.",
    },
    {
        "title": "[smoke] answered high views",
        "contents": "高浏览量已回答问题，用于检查按热度排序时的列表稳定性。",
        "created_at": "2026-01-02 09:35:00",
        "views": 512,
        "reply_cnt": 1,
        "pinned": False,
        "deleted_at": None,
        "answer": "[smoke] high views answer.",
    },
    {
        "title": "[smoke] pinned answered",
        "contents": "已置顶且已回答的问题，用于检查双状态徽标。",
        "created_at": "2026-01-02 09:40:00",
        "views": 64,
        "reply_cnt": 1,
        "pinned": True,
        "deleted_at": None,
        "answer": "[smoke] pinned answered teacher answer.",
    },
    {
        "title": "[smoke] pinned recent unanswered",
        "contents": "较新的置顶未回答问题，用于检查置顶排序。",
        "created_at": "2026-01-02 09:45:00",
        "views": 42,
        "reply_cnt": 0,
        "pinned": True,
        "deleted_at": None,
    ...
    {
        "title": "[smoke] deleted answered",
        "contents": "已删除但曾经回答过的问题，用于检查已删除状态优先级。",
        "created_at": "2026-01-02 09:50:00",
        "views": 27,
        "reply_cnt": 1,
        "pinned": False,
        "deleted_at": "2026-01-02 10:05:00",
        "answer": "[smoke] deleted answered teacher answer.",
    },
    {
        "title": "[smoke] deleted high views",
        "contents": "高浏览量已删除问题，用于检查删除列表和热度排序。",
        "created_at": "2026-01-02 09:55:00",
        "views": 768,
        "reply_cnt": 0,
        "pinned": False,
        "deleted_at": "2026-01-02 10:10:00",
        "answer": None,
    },
    {
        "title": "[smoke] markdown symbols",
        "contents": "包含 Markdown 符号的提问：**bold**、`code`、[link](https://example.com)，用于检查摘要展示。",
    ...
    },
    {
        ...
        "pinned": False,
        "deleted_at": None,
        "answer": "[smoke] multiline content answer.",
    },
    {
        "title": "[smoke] pinned long title for wrapping behavior in teacher inbox card",
        "contents": "长标题置顶问题，用于检查标题和状态徽标在同一行时的挤压与换行表现。",
        "created_at": "2026-01-02 10:10:00",
        "views": 96,
        "reply_cnt": 0,
        "pinned": True,
        "deleted_at": None,
    ...
    {
        "title": "[smoke] pagination filler",
        "contents": "额外填充问题，用于让教师收件箱冒烟数据超过第一页常见展示数量。",
